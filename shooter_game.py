...
img_back = "map1.png" #game background
img_bullet = "bow.png" #bullet
img_hero = "Steve.png" #hero
img_enemy = "creeperlelo.jpg" #enemy
score = 0 #ships destroyed
goal = 60 #how many ships need to be shot down to win
lost = 0 #ships missed
